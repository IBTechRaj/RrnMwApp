            ...
            <View style={{ flex: 1 }}>
                ...
                <DataTable>
                    <DataTable.Header>
                        ...
                        <DataTable.Title numeric>Offer Price</DataTable.Title>
                    </DataTable.Header>
                    {serviceData && serviceData.map(({ id, sname, price, offerprice, description }) => (
                    <DataTable.Row>
                            <DataTable.Cell>{sname}</DataTable.Cell>
                            <DataTable.Cell numeric>{price}</DataTable.Cell>
                            <DataTable.Cell numeric>{offerprice}</DataTable.Cell>
                        </DataTable.Row>
                    ))}
                    </DataTable>
                {/* <View style={{ flex: 1, backgroundColor: '#414880' }}>
                    
                        {serviceData && serviceData.map(({ id, sname, price, offerprice, description }) => (
                            <Text  key={id} style={styles.table}>
                                {sname}{'          '}
                ...
                <View style={{ flex: 1, backgroundColor: '#414880', margin: 0 }} >
                    <Text style={styles.subheader}>
                        Car Decor
                    </Text>
                </View>
